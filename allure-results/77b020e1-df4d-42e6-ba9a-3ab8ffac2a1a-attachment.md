...
- Name: tests\loginPage.spec.js >> DemoBlaze Login Tests >> Invalid Login
- Location: tests\loginPage.spec.js:24:3
...
```ts
  ...
  7  |     this.username = page.locator('#loginusername');
  8  |     this.password = page.locator('#loginpassword');
  9  |     this.loginBtn = page.locator('//button[text()="Log in"]');
  10 |   }
  11 | 
  12 |   async goto() {
  ...
  17 |     // Handle alert popup (for invalid login / add to cart alerts)
